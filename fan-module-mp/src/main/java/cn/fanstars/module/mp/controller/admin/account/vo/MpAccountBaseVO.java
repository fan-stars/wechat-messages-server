package cn.fanstars.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号微信号", requiredMode = Schema.RequiredMode.REQUIRED, example = "fanyuanma")
    ...
    @Schema(description = "备注", example = "请关注繁星源码，学习技术")
