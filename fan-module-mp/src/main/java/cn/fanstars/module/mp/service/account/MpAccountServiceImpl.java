package cn.fanstars.module.mp.service.account;
...
import cn.fanstars.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.fanstars.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.fanstars.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.fanstars.module.mp.convert.account.MpAccountConvert;
import cn.fanstars.module.mp.dal.dataobject.account.MpAccountDO;
import cn.fanstars.module.mp.dal.mysql.account.MpAccountMapper;
import cn.fanstars.module.mp.enums.ErrorCodeConstants;
...
import static cn.fanstars.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.fanstars.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.fanstars.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 fan-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
