...
import cn.fanstars.module.mp.framework.mp.core.DefaultMpServiceFactory;
import cn.fanstars.module.mp.framework.mp.core.MpServiceFactory;
import cn.fanstars.module.mp.service.handler.menu.MenuHandler;
import cn.fanstars.module.mp.service.handler.message.MessageReceiveHandler;
import cn.fanstars.module.mp.service.handler.message.MessageAutoReplyHandler;
import cn.fanstars.module.mp.service.handler.other.KfSessionHandler;
import cn.fanstars.module.mp.service.handler.other.NullHandler;
import cn.fanstars.module.mp.service.handler.other.ScanHandler;
import cn.fanstars.module.mp.service.handler.other.StoreCheckNotifyHandler;
import cn.fanstars.module.mp.service.handler.user.LocationHandler;
import cn.fanstars.module.mp.service.handler.user.SubscribeHandler;
import cn.fanstars.module.mp.service.handler.user.UnsubscribeHandler;
