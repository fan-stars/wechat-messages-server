package cn.fanstars.framework.xss.config;

import cn.fanstars.framework.common.enums.WebFilterOrderEnum;
import cn.fanstars.framework.xss.core.clean.JsoupXssCleaner;
...
@ConditionalOnProperty(prefix = "fan.xss", name = "enable", havingValue = "true", matchIfMissing = true) // 设置为 false 时，禁用
public class FanXssAutoConfiguration implements WebMvcConfigurer {
