package cn.fanstars.framework.jackson.config;

import cn.fanstars.framework.common.util.json.JsonUtils;
import cn.fanstars.framework.common.util.json.databind.NumberSerializer;
import cn.fanstars.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.fanstars.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class FanJacksonAutoConfiguration {
