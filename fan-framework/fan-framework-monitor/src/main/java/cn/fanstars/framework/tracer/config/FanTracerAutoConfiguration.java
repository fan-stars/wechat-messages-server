package cn.fanstars.framework.tracer.config;

import cn.fanstars.framework.common.enums.WebFilterOrderEnum;
import cn.fanstars.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "fan.tracer", value = "enable", matchIfMissing = true)
public class FanTracerAutoConfiguration {
