package cn.fanstars.module.system.service.social;
...
import cn.fanstars.framework.common.util.cache.CacheUtils;
import cn.fanstars.framework.common.util.http.HttpUtils;
import cn.fanstars.framework.common.util.object.BeanUtils;
import cn.fanstars.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.fanstars.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.fanstars.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.fanstars.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.fanstars.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.fanstars.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.fanstars.module.system.dal.dataobject.social.SocialClientDO;
import cn.fanstars.module.system.dal.mysql.social.SocialClientMapper;
import cn.fanstars.module.system.dal.redis.RedisKeyConstants;
import cn.fanstars.module.system.enums.social.SocialTypeEnum;
import cn.fanstars.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.fanstars.framework.common.util.collection.MapUtils.findAndThen;
import static cn.fanstars.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.fanstars.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.fanstars.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${fan.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${fan.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/fan-cloud/pulls/230
