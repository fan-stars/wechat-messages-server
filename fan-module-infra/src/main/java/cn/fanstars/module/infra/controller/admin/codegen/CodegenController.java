package cn.fanstars.module.infra.controller.admin.codegen;
...
import cn.fanstars.module.infra.convert.codegen.CodegenConvert;
...
import cn.fanstars.module.infra.service.codegen.CodegenService;
...
import static cn.fanstars.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.fanstars.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "fan"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "繁星")
    })
