...
public class ProjectReactor {
    ...
    static final String ARTIFACT_ID_NEW = "fan-base";
...
//        PROJECT_NAME_NEW = ARTIFACT_ID_NEW + "-" + groupIdNews[groupIdNews.length - 1];
        PROJECT_BASE_DIR_NEW = PROJECT_BASE_DIR.substring(0, PROJECT_BASE_DIR.lastIndexOf(separator) + 1) + ARTIFACT_ID_NEW;
    }
